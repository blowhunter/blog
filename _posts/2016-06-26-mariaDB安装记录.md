...
.source.python .variable.parameter {
  ...
  <body class='markdown-preview' data-use-github-style><p>--
layout: post
title: MariaDB 安装记录
category: 数据库
tagline: &quot;数据库&quot;
tags: mariadb linux mysql 数据库</p>
<h2 id="published-true">published: true</h2>
<p>{% include JB/setup %}</p>
<h1 id="mariadb-">MariaDB 安装记录</h1>
<hr>
<ul>
<li>首先，我们可以在cn库里找到mariadb的安装包，直接使用命令安装。<pre class="editor-colors lang-text"></pre></li>
<li>安装完成之后，按照提醒先启动mariadb的服务，命令行：<pre class="editor-colors lang-text"></pre></li>
<li><p>然后测试命令看是否设置成功。</p>
